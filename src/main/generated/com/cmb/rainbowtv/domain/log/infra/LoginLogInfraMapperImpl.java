...
@Component
public class LoginLogInfraMapperImpl implements LoginLogInfraMapper {

    @Override
    public LoginLog toLoginLog(LoginLogEntity loginLogEntity) {
        ...
        loginLog.createdAt( loginLogEntity.getCreatedAt() );
        loginLog.updatedAt( loginLogEntity.getUpdatedAt() );
        loginLog.llIdx( loginLogEntity.getLlIdx() );
        loginLog.llType( loginLogEntity.getLlType() );
        loginLog.member( memberEntityToMember( loginLogEntity.getMember() ) );
        loginLog.clientIp( loginLogEntity.getClientIp() );
        loginLog.llDate( loginLogEntity.getLlDate() );
    ...
    public LoginLogEntity toLoginLogEntity(LoginLog loginLog) {
        ...
        loginLogEntity.member( memberToMemberEntity( loginLog.getMember() ) );
