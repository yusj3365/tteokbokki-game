...
import com.cmb.rainbowtv.domain.citychannel.infra.data.entity.CityChannelHistoryEntity;
...
import com.cmb.rainbowtv.domain.citychannel.model.CityChannelHistory;
...
@Component
public class CityChannelHistoryInfraMapperImpl implements CityChannelHistoryInfraMapper {

    @Override
    public CityChannelHistory toCityChannelHistory(CityChannelHistoryEntity entity) {
        if ( entity == null ) {
            return null;
        }

        CityChannelHistory.CityChannelHistoryBuilder<?, ?> cityChannelHistory = CityChannelHistory.builder();

        cityChannelHistory.createdAt( entity.getCreatedAt() );
        cityChannelHistory.updatedAt( entity.getUpdatedAt() );
        cityChannelHistory.cchIdx( entity.getCchIdx() );
        cityChannelHistory.cityChannel( cityChannelEntityToCityChannel( entity.getCityChannel() ) );
        cityChannelHistory.member( memberEntityToMember( entity.getMember() ) );

        return cityChannelHistory.build();
    }

    @Override
    public CityChannelHistoryEntity toCityChannelHistoryEntity(CityChannelHistory model) {
        if ( model == null ) {
            return null;
        }

        CityChannelHistoryEntity.CityChannelHistoryEntityBuilder cityChannelHistoryEntity = CityChannelHistoryEntity.builder();

        cityChannelHistoryEntity.cchIdx( model.getCchIdx() );
        cityChannelHistoryEntity.cityChannel( cityChannelToCityChannelEntity( model.getCityChannel() ) );
        cityChannelHistoryEntity.member( memberToMemberEntity( model.getMember() ) );

        return cityChannelHistoryEntity.build();
    }
