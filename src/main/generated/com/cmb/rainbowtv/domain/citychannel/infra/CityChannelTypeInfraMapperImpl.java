...
import com.cmb.rainbowtv.domain.citychannel.infra.data.entity.CityChannelTypeEntity;
...
import com.cmb.rainbowtv.domain.citychannel.model.CityChannelType;
...
@Component
public class CityChannelTypeInfraMapperImpl implements CityChannelTypeInfraMapper {

    @Override
    public CityChannelType toCityChannelType(CityChannelTypeEntity cityChannelTypeEntity) {
        if ( cityChannelTypeEntity == null ) {
            return null;
        }

        CityChannelType.CityChannelTypeBuilder<?, ?> cityChannelType = CityChannelType.builder();

        cityChannelType.createdAt( cityChannelTypeEntity.getCreatedAt() );
        cityChannelType.updatedAt( cityChannelTypeEntity.getUpdatedAt() );
        cityChannelType.cctIdx( cityChannelTypeEntity.getCctIdx() );
        cityChannelType.cityChannel( cityChannelEntityToCityChannel( cityChannelTypeEntity.getCityChannel() ) );
        cityChannelType.cctType( cityChannelTypeEntity.getCctType() );

        return cityChannelType.build();
    }

    @Override
    public CityChannelTypeEntity toCityChannelTypeEntity(CityChannelType cityChannelType) {
        if ( cityChannelType == null ) {
            return null;
        }

        CityChannelTypeEntity.CityChannelTypeEntityBuilder cityChannelTypeEntity = CityChannelTypeEntity.builder();

        cityChannelTypeEntity.cctIdx( cityChannelType.getCctIdx() );
        cityChannelTypeEntity.cityChannel( cityChannelToCityChannelEntity( cityChannelType.getCityChannel() ) );
        cityChannelTypeEntity.cctType( cityChannelType.getCctType() );

        return cityChannelTypeEntity.build();
    }
