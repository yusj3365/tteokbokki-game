package com.cmb.rainbowtv.domain.top10.infra;
...
import com.cmb.rainbowtv.domain.top10.infra.data.entity.Top10MemberGenreEntity;
import com.cmb.rainbowtv.domain.top10.model.Top10MemberGenre;
...
@Component
public class Top10V2InfraMapperImpl implements Top10V2InfraMapper {

    @Override
    public Top10MemberGenre toTop10MemberGenre(Top10MemberGenreEntity top10MemberGenreEntity) {
        if ( top10MemberGenreEntity == null ) {
            return null;
        }

        Top10MemberGenre.Top10MemberGenreBuilder<?, ?> top10MemberGenre = Top10MemberGenre.builder();

        top10MemberGenre.createdAt( top10MemberGenreEntity.getCreatedAt() );
        top10MemberGenre.updatedAt( top10MemberGenreEntity.getUpdatedAt() );
        top10MemberGenre.tmgIdx( top10MemberGenreEntity.getTmgIdx() );
        top10MemberGenre.toContent( top10MemberGenreEntity.getToContent() );
        top10MemberGenre.member( memberEntityToMember( top10MemberGenreEntity.getMember() ) );
        top10MemberGenre.mediaGenre( mediaGenreEntityToMediaGenre( top10MemberGenreEntity.getMediaGenre() ) );

        return top10MemberGenre.build();
    }

    @Override
    public Top10MemberGenreEntity toTop10MemberGenreEntity(Top10MemberGenre top10MemberGenre) {
        if ( top10MemberGenre == null ) {
            return null;
        }

        Long tmgIdx = null;
        Top10ContentEnum toContent = null;
        MemberEntity member = null;
        MediaGenreEntity mediaGenre = null;

        tmgIdx = top10MemberGenre.getTmgIdx();
        toContent = top10MemberGenre.getToContent();
        member = memberToMemberEntity( top10MemberGenre.getMember() );
        mediaGenre = mediaGenreToMediaGenreEntity( top10MemberGenre.getMediaGenre() );

        Top10MemberGenreEntity top10MemberGenreEntity = new Top10MemberGenreEntity( tmgIdx, toContent, member, mediaGenre );

        top10MemberGenreEntity.setCreatedAt( top10MemberGenre.getCreatedAt() );
        top10MemberGenreEntity.setUpdatedAt( top10MemberGenre.getUpdatedAt() );

        return top10MemberGenreEntity;
    }
