package com.cmb.rainbowtv.domain.lgfeed.infra;

import com.cmb.rainbowtv.domain.lgfeed.infra.data.entity.LgFeedContentEntity;
import com.cmb.rainbowtv.domain.lgfeed.model.LgFeedContent;
...
@Component
public class LgFeedContentInfraMapperImpl implements LgFeedContentInfraMapper {

    @Override
    public LgFeedContent toLgFeedContent(LgFeedContentEntity lgFeedContentEntity) {
        if ( lgFeedContentEntity == null ) {
            return null;
        }

        LgFeedContent.LgFeedContentBuilder<?, ?> lgFeedContent = LgFeedContent.builder();

        lgFeedContent.createdAt( lgFeedContentEntity.getCreatedAt() );
        lgFeedContent.updatedAt( lgFeedContentEntity.getUpdatedAt() );
        lgFeedContent.lfcIdx( lgFeedContentEntity.getLfcIdx() );
        lgFeedContent.media( mediaEntityToMedia( lgFeedContentEntity.getMedia() ) );
        lgFeedContent.mediaCategory( mediaCategoryEntityToMediaCategory( lgFeedContentEntity.getMediaCategory() ) );
        lgFeedContent.lfcDeeplinkId( lgFeedContentEntity.getLfcDeeplinkId() );
        lgFeedContent.lfcSeq( lgFeedContentEntity.getLfcSeq() );
        lgFeedContent.lfcThumbUrl( lgFeedContentEntity.getLfcThumbUrl() );

        return lgFeedContent.build();
    }

    @Override
    public LgFeedContentEntity toLgFeedContentEntity(LgFeedContent lgFeedContent) {
        if ( lgFeedContent == null ) {
            return null;
        }

        LgFeedContentEntity.LgFeedContentEntityBuilder lgFeedContentEntity = LgFeedContentEntity.builder();

        lgFeedContentEntity.lfcIdx( lgFeedContent.getLfcIdx() );
        lgFeedContentEntity.media( mediaToMediaEntity( lgFeedContent.getMedia() ) );
        lgFeedContentEntity.mediaCategory( mediaCategoryToMediaCategoryEntity( lgFeedContent.getMediaCategory() ) );
        lgFeedContentEntity.lfcDeeplinkId( lgFeedContent.getLfcDeeplinkId() );
        lgFeedContentEntity.lfcSeq( lgFeedContent.getLfcSeq() );
        lgFeedContentEntity.lfcThumbUrl( lgFeedContent.getLfcThumbUrl() );

        return lgFeedContentEntity.build();
    }
