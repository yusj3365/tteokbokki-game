package com.cmb.rainbowtv.domain.block.infra;

import com.cmb.rainbowtv.domain.block.infra.data.entity.BlockEntity;
import com.cmb.rainbowtv.domain.block.model.Block;
...
@Component
public class BlockInfraMapperImpl implements BlockInfraMapper {
    ...
    public BlockEntity toEntity(Block block) {
        ...
        blockEntity.blIdx( block.getBlIdx() );
        blockEntity.member( memberToMemberEntity( block.getMember() ) );
        blockEntity.blBlock( block.getBlBlock() );

        return blockEntity.build();
    }

    @Override
    public Block toModel(BlockEntity entity) {
        if ( entity == null ) {
            return null;
        }
        ...
        block.createdAt( entity.getCreatedAt() );
        block.updatedAt( entity.getUpdatedAt() );
        block.blIdx( entity.getBlIdx() );
        block.member( memberEntityToMember( entity.getMember() ) );
        block.blBlock( entity.getBlBlock() );
