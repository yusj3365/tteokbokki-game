...
@Component
public class MediaShopTradeInfraMapperImpl implements MediaShopTradeInfraMapper {

    @Override
    public MediaShopTradeHistoryEntity toMediaShopTradeHistoryEntity(MediaShopTradeHistory mediaShopTradeHistory) {
    ...
    @Override
    public MediaShopTradeHistory toMediaShopTradeHistory(MediaShopTradeHistoryEntity entity) {
        if ( entity == null ) {
            return null;
        }
        ...
        mediaShopTradeHistory.createdAt( entity.getCreatedAt() );
        mediaShopTradeHistory.updatedAt( entity.getUpdatedAt() );
        mediaShopTradeHistory.msthIdx( entity.getMsthIdx() );
        mediaShopTradeHistory.member( memberEntityToMember( entity.getMember() ) );
        mediaShopTradeHistory.media( mediaEntityToMedia( entity.getMedia() ) );
        mediaShopTradeHistory.msthTel( entity.getMsthTel() );
        mediaShopTradeHistory.msthAddr( entity.getMsthAddr() );
        mediaShopTradeHistory.msthAddrDetail( entity.getMsthAddrDetail() );
        mediaShopTradeHistory.msthZipcode( entity.getMsthZipcode() );
        mediaShopTradeHistory.msthReceiver( entity.getMsthReceiver() );
        mediaShopTradeHistory.msthStatus( entity.getMsthStatus() );
        mediaShopTradeHistory.mcAttribute( entity.getMcAttribute() );
        mediaShopTradeHistory.msthCompany( entity.getMsthCompany() );
        mediaShopTradeHistory.msthHp( entity.getMsthHp() );
        mediaShopTradeHistory.msthCancelReason( entity.getMsthCancelReason() );
