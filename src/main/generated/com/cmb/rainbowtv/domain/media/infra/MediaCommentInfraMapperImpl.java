...
import com.cmb.rainbowtv.domain.media.infra.data.entity.MediaCommentEntity;
...
import com.cmb.rainbowtv.domain.media.model.MediaComment;
...
@Generated(
    ...
    date = "2026-01-20T12:49:58+0900",
    comments = "version: 1.6.3, compiler: javac, environment: Java 17.0.6 (Oracle Corporation)"
)
@Component
public class MediaCommentInfraMapperImpl implements MediaCommentInfraMapper {

    @Override
    public MediaComment toMediaComment(MediaCommentEntity mediaCommentEntity) {
        if ( mediaCommentEntity == null ) {
            return null;
        }

        MediaComment.MediaCommentBuilder<?, ?> mediaComment = MediaComment.builder();

        mediaComment.createdAt( mediaCommentEntity.getCreatedAt() );
        mediaComment.updatedAt( mediaCommentEntity.getUpdatedAt() );
        mediaComment.mcoIdx( mediaCommentEntity.getMcoIdx() );
        mediaComment.mcoType( mediaCommentEntity.getMcoType() );
        mediaComment.media( mediaEntityToMedia( mediaCommentEntity.getMedia() ) );
        mediaComment.member( memberEntityToMember( mediaCommentEntity.getMember() ) );
        mediaComment.mcoComment( mediaCommentEntity.getMcoComment() );
        mediaComment.mcoTv( mediaCommentEntity.getMcoTv() );

        return mediaComment.build();
    }

    @Override
    public MediaCommentEntity toMediaCommentEntity(MediaComment mediaComment) {
        if ( mediaComment == null ) {
            return null;
        }

        MediaCommentEntity.MediaCommentEntityBuilder mediaCommentEntity = MediaCommentEntity.builder();

        mediaCommentEntity.mcoIdx( mediaComment.getMcoIdx() );
        mediaCommentEntity.mcoType( mediaComment.getMcoType() );
        mediaCommentEntity.media( mediaToMediaEntity( mediaComment.getMedia() ) );
        mediaCommentEntity.member( memberToMemberEntity( mediaComment.getMember() ) );
        mediaCommentEntity.mcoComment( mediaComment.getMcoComment() );
        mediaCommentEntity.mcoTv( mediaComment.getMcoTv() );

        return mediaCommentEntity.build();
    }
