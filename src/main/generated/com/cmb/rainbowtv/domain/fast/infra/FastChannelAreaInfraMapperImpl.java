...
@Component
public class FastChannelAreaInfraMapperImpl implements FastChannelAreaInfraMapper {
    ...
    public FastChannelArea toFastChannelArea(FastChannelByAreaEntity fastChannelByAreaEntity) {
        ...
        fastChannelArea.fastChannel( fastChannelEntityToFastChannel( fastChannelByAreaEntity.getFastChannel() ) );
    ...
    @Override
    public FastChannelByAreaEntity toFastChannelAreaEntity(FastChannelArea fastChannelArea) {
        if ( fastChannelArea == null ) {
            return null;
        }

        FastChannelByAreaEntity.FastChannelByAreaEntityBuilder fastChannelByAreaEntity = FastChannelByAreaEntity.builder();

        fastChannelByAreaEntity.fcbaIdx( fastChannelArea.getFcbaIdx() );
        fastChannelByAreaEntity.fastChannel( fastChannelToFastChannelEntity( fastChannelArea.getFastChannel() ) );
        fastChannelByAreaEntity.areaDefine( areaDefineToAreaDefineEntity( fastChannelArea.getAreaDefine() ) );
        fastChannelByAreaEntity.fcbaSi( fastChannelArea.getFcbaSi() );

        return fastChannelByAreaEntity.build();
    }
