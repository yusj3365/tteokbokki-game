...
@Component
public class FastChannelAdInfraMapperImpl implements FastChannelAdInfraMapper {

    @Override
    public FastChannelAd toFastChannelAd(FastChannelAdEntity fastChannelAdEntity) {
    ...
    @Override
    public FastChannelAdEntity toFastChannelAdEntity(FastChannelAd fastChannelAd) {
    ...
    @Override
    public List<FastChannelAdEntity> toAdEntityList(List<FastChannelAd> ads) {
        if ( ads == null ) {
            return null;
        }

        List<FastChannelAdEntity> list = new ArrayList<FastChannelAdEntity>( ads.size() );
        for ( FastChannelAd fastChannelAd : ads ) {
            list.add( toFastChannelAdEntity( fastChannelAd ) );
        }
