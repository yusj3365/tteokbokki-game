...
import com.cmb.rainbowtv.domain.content.infra.data.entity.HomeDisplayEntity;
import com.cmb.rainbowtv.domain.content.model.HomeDisplay;
...
@Component
public class HomeDisplayInfraMapperImpl implements HomeDisplayInfraMapper {

    @Override
    public HomeDisplay toHomeDisplay(HomeDisplayEntity entity) {
        if ( entity == null ) {
            return null;
        }

        HomeDisplay.HomeDisplayBuilder<?, ?> homeDisplay = HomeDisplay.builder();

        homeDisplay.createdAt( entity.getCreatedAt() );
        homeDisplay.updatedAt( entity.getUpdatedAt() );
        homeDisplay.hdIdx( entity.getHdIdx() );
        homeDisplay.hdType( entity.getHdType() );
        homeDisplay.hdCategory( entity.getHdCategory() );
        homeDisplay.media( mediaEntityToMedia( entity.getMedia() ) );
        homeDisplay.hdIsDisplay( entity.getHdIsDisplay() );
        homeDisplay.hdSeq( entity.getHdSeq() );
        homeDisplay.hdTitleDisplay( entity.getHdTitleDisplay() );
        homeDisplay.hdTitle1( entity.getHdTitle1() );
        homeDisplay.hdTitle2( entity.getHdTitle2() );
        homeDisplay.hdView( entity.getHdView() );
        homeDisplay.hdHit( entity.getHdHit() );

        return homeDisplay.build();
    }

    @Override
    public HomeDisplayEntity toHomeDisplayEntity(HomeDisplay homeDisplay) {
        if ( homeDisplay == null ) {
            return null;
        }

        HomeDisplayEntity.HomeDisplayEntityBuilder homeDisplayEntity = HomeDisplayEntity.builder();

        homeDisplayEntity.hdIdx( homeDisplay.getHdIdx() );
        homeDisplayEntity.hdType( homeDisplay.getHdType() );
        homeDisplayEntity.hdCategory( homeDisplay.getHdCategory() );
        homeDisplayEntity.media( mediaToMediaEntity( homeDisplay.getMedia() ) );
        homeDisplayEntity.hdIsDisplay( homeDisplay.getHdIsDisplay() );
        homeDisplayEntity.hdSeq( homeDisplay.getHdSeq() );
        homeDisplayEntity.hdTitleDisplay( homeDisplay.getHdTitleDisplay() );
        homeDisplayEntity.hdTitle1( homeDisplay.getHdTitle1() );
        homeDisplayEntity.hdTitle2( homeDisplay.getHdTitle2() );
        homeDisplayEntity.hdView( homeDisplay.getHdView() );
        homeDisplayEntity.hdHit( homeDisplay.getHdHit() );

        return homeDisplayEntity.build();
    }
